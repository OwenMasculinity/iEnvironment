...
<body>
	...
	<div id="content">
		...
		<ul class="tab-menu">
			...
			<li><a href="hourly.php?location=<?php echo $_GET['location']; ?>" class="active"><?php echo $lang['MENU_HOYRLY']; ?></a></li>
		...
		<?php 
		for($i=0;$i<24;$i++) { // Loop 24 times to get weather for next 24 hours
			echo "<div>";
					echo "<div class='info'>";
						echo "<ul>";
								...
								echo "<ul class='info-meta'>";						
									echo "<li class='other'>";
										echo "<div class='meta-wrapper'>";
											GetTime($i,$forecast); // Get time for every hour and visualize
											...
											echo "</span>";
											echo "<span class='title'>". $forecast->hourly->data[$i]->summary . "</span>"; // Show summary weather
											echo "<span class='temperature'>";
												echo "<span class='max'>";
													echo ceil($forecast->hourly->data[$i]->temperature) . "&#176;</span><br>"; // Show temperature for this hour
												echo "<small>" . $lang['WEATHER_CURRENTLY_APP_TEMP'] . "</small> <span class='min'>" . ceil($forecast->hourly->data[$i]->apparentTemperature) ."</span>&#176;"; // Show temperature which will be felt for this hour
											echo "</span>";
											echo "<span class='humidity-cloud'>";
												...
												echo "<span class='point'>" . $forecast->hourly->data[$i]->humidity * 100 ."</span>%&nbsp;&nbsp;&nbsp"; // Show humidity in percent
												echo "<img src='img/icons/cloudy.png' width='32' height='32' title='" . $lang['WEATHER_IMG_TITLE_CLOUD_COVER'] . "' class='icon' />";
												echo "<span class='point'> ". $forecast->hourly->data[$i]->cloudCover * 100 ."</span>%"; // Show cloud cover in percent
											echo "</span>";
