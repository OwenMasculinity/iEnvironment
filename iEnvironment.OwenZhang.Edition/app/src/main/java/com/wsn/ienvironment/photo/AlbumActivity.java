...
import com.wsn.ienvironment.photo.adapter.AlbumGridViewAdapter;
import com.wsn.ienvironment.photo.util.AlbumHelper;
import com.wsn.ienvironment.photo.util.Bimp;
import com.wsn.ienvironment.photo.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, PhotoMain.class);
			startActivity(intent);
			finish();
		}
