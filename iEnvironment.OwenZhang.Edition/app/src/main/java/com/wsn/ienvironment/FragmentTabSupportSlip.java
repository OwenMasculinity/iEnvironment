...
public class FragmentTabSupportSlip extends FragmentActivity
	...
	private final Class[] fragments = { Weather.class, Environment.class,
			LiveAction.class, Me.class };
	 ...
	 */
	 private void initView() {
		...
		* author：张凌霄
		 ...
		 *获取TabHost高度
		  */
		 mTabHost.measure(View.MeasureSpec.makeMeasureSpec(0,
				 View.MeasureSpec.UNSPECIFIED), View.MeasureSpec
				 .makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED));
		 TabHeight=mTabHost.getMeasuredHeight();
		 // mTabHost.setCurrentTab(0);
	 }
